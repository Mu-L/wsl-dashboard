...
- [📢 กลุ่มชุมชนทางการ](#-กลุ่มชุมชนทางการ)
...
- **การกำหนดเวลางาน**: การจัดการกำหนดเวลางานที่ยืดหยุ่น รองรับการทำงานอัตโนมัติของสคริปต์และคำสั่งในอินสแตนซ์ WSL ตามเวลาหรือช่วงเวลาที่กำหนดสำหรับการดำเนินการอัตโนมัติ
...
- **การต่อเชื่อมดิสก์**: ต่อเชื่อมและจัดการดิสก์เสมือน VHDX ของอินสแตนซ์ WSL โดยตรง รองรับการต่อเชื่อม การยกเลิกการต่อเชื่อม และการจัดการดิสก์ ทำให้ง่ายต่อการถ่ายโอนไฟล์ระหว่างโฮสต์และ WSL
...
ยินดีต้อนรับสู่กลุ่มชุมชน WSL UI ทางการ! เข้าร่วมช่องทางของเราเพื่อพูดคุยเคล็ดลับการใช้งาน รายงานปัญหา รับอัปเดตล่าสุด และเชื่อมต่อกับนักพัฒนาและผู้ใช้อื่น

| กลุ่มทั่วโลก (Telegram) | กลุ่มภาษาจีน (WeChat) |
| :---: | :---: |
...
| สแกนเพื่อเข้าร่วม | สแกนเพื่อเข้าร่วม |
