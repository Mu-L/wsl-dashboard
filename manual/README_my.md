...
- [📢 တရားဝင့် လူမဆှဲ အုပ့်စု](#-တရားဝင့်-လူမဆှဲ-အုပ့်စု)
...
- **အလုပ်ချိန်ဇယား**: WSL instance များတွင် သတ်မှတ်ထားသော အချိန် သို့မဟုတ် ကြားကာလများတွင် script များနှင့် command များကို အလိုအလျောက် လုပ်ဆောင်ပေးသော လိုက်လျောညီထွေရှိသည့် အလုပ်ချိန်ဇယား စီမံခန့်ခွဲမှု။
...
- **ဒစ်ခ် တပ်ဆင်ခြင်း**: WSL instance VHDX virtual disk များကို တိုက်ရိုက် mount လုပ်ပြီး စီမံခန့်ခွဲခြင်း၊ mount, unmount နှင့် disk စီမံခန့်ခွဲမှု လုပ်ဆောင်ချက်များကို ပံ့ပိုးပေးကာ host နှင့် WSL အကြား ဖိုင်များ လွှဲပြောင်းရန် လွယ်ကူစေသည်။
...
## 📢 တရားဝင့် လူမဆှဲ အုပ့်စု

WSL UI တရားဝင့် လူမဆှဲ အုပ့်စုမှာ ကြိုမှိုက့်ပင့်ဆိုပါသည့်! အသုံးပြုနည့်း အကြံဉာဏ့်မည့်းကို ဆြေးနြေးရန့်, ပြဿနာမည့်းကို အသိပေးရန့်, နန့်နှုတ့်စားရန့် နှင့် ဖြုံ့်ဖြိုးသုးမည့်းနှင့် အခြား အသုံးပြုသုးမည့်းနှင့် ချိတ့်ဆက့်ရန့် ကျှူန့်ပြုတိုင့်း၏ မကှုံးင့်းရန့် ဝင့်ပါ။

| ကမ္ဘာ့ အုပ့်စု (Telegram) | တရုတ့် အုပ့်စု (WeChat) |
| :---: | :---: |
...
| ဝင့်ရန့် စကန့်နာ ပြုပါ | ဝင့်ရန့် စကန့်နာ ပြုပါ |
